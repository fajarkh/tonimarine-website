...
>
    ...
    <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-between p-2">
        <a class="flex items-center space-x-3 rtl:space-x-reverse" href="/" wire:navigate aria-label="Go to homepage">
            <img class="h-30 w-100 rounded block dark:hidden" src="{{ asset("img/logo-light-2.png") }}" alt="{{ app_name() }} Logo" />
            <img class="h-30 w-100 rounded hidden dark:block" src="{{ asset("img/logo-dark-2.png") }}" alt="{{ app_name() }} Logo" />
        </a>
